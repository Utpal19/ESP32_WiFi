...
#define WIFI_AP_CHANNEL             1           // AP Channels
#define WIFI_AP_SSID_HIDDEN         0           // AP visibility (0- visible, 1 - Hidden)
#define WIFI_AP_MAX_CONNECTIONS     5           // AP max clients
#define WIFI_AP_BEACON_INTERVAL     100         // AP beacon interval: 100 ms recommended(default)
#define WIFI_AP_IP                  "192.168.0.1"   // AP default IP
#define WIFI_AP_GATEWAY             "192.168.0.1"   // AP default gateway (Should be same as IP)
